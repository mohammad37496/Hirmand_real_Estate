    ...
    <div className="commission-layout">
        ...
        {result ? (
          <div className="commission-result" aria-live="polite">
            ...
            <p className="commission-disclaimer">
              این فرمول برای برآورد است: سود ماهانه = مبلغ × نرخ ÷ ۱۲۰۰. نرخ واقعی و شرایط هر بانک
              می‌تواند متفاوت باشد؛ نتیجه را با قرارداد بانکی تطبیق دهید.
            </p>
          </div>
        ) : (
      ...
      <aside className="commission-guide">
        ...
        <ol>
          ...
          <li>نرخ انتخابی نمونه است و می‌توانید نرخ اعلامی بانک خود را وارد کنید</li>
        </ol>
      </aside>
    </div>
  );
      ...
      <div className="commission-box">
        ...
        {result ? (
          <div className="commission-result" aria-live="polite">
            ...
            <p className="commission-disclaimer">
              این ابزار برای برآورد است و جایگزین جدول رسمی بانک نیست. رقم نهایی قسط، کارمزد و سود را
              از بانک عامل و قرارداد تسهیلات تطبیق دهید.
            </p>
          </div>
        ) : (
