...
export const NAV = [
  ...
  { id: "listings", label: "فایل‌ها", to: "/", hash: "listings" },
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "پس از توافق، قرارداد در سامانه ثبت می‌شود و یک کد رهگیری صادر می‌گردد تا معامله قابل پیگیری و معتبر باشد. این بخش به‌زودی روی سایت فعال می‌شود؛ تا آن زمان از طریق تماس با دفتر همراهتان هستیم.",
  },
] as const;
