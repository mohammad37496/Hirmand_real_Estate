...
export const NEIGHBORHOOD_GROUPS: { title: string; items: Neighborhood[] }[] = [
  {
    ...
    items: [
      "آمادگاه","ابن‌سینا","احمدآباد","باب‌الدشت","باغ‌کاران","بیدآباد","پشت‌بارو","پاچنار","جلفا",
      "جوزدان","جویباره","چرخاب","درب‌کوش","دردشت","دروازه دولت","سنبلستان","سی‌وسه‌پل","شهشهان",
      "شهزاده ابراهیم","شیخ صدوق","صائب","عباس‌آباد","علی‌قلی‌آقا","قلعه تبرک","قلعه طبرک","مهرآباد",
      "نقش جهان","هاتف","خواجو","حسن‌آباد","چهارباغ بالا","چهارباغ پایین","چهارباغ عباسی","شمس‌آباد","طوقچی",
    ].map((name) => ({ name, lat: 32.65, lng: 51.67 })),
  },
  {
    title: "جنوب اصفهان",
    items: [
      "استادان","آبشار","آتشگاه","باغ دریاچه","باغ زرشک","باغ غدیر","بهارستان","تخت فولاد","دنارت",
      "ردان","رزمندگان","سپاهان‌شهر","سیچان","صفه","شیخ صدوق","فیض","کوی امام","کوی سپاهان","گل‌نرگس",
  ...
  },
  {
    title: "شمال و شرق",
    items: [
      "آزادان","ارزنان","ارغوانیه","اشکاوند","اسماعیلی","باقوشخانه","بختیار دشت","برزانده","برازنده",
      "برج کاوه","پروین","پنج‌آذر","پوزوه","پنارت","خانه اصفهان","خواجه عمید","دولت‌آباد","راران",
      "رحیم‌آباد","زینبیه","جی","جی‌شیر","شیخ اشراق","شیخ طوسی","شاهد","عسکریه","فجر","فروردین",
      "قهجاورستان","کوهسار شرق","کوی نرگس","کوی میلاد","لاله","ملک‌شهر","مشتاق","محمودآباد","مولوی",
      "ناصرخسرو","نگارستان","یونارت","خوراسگان","هفتون","سروستان","دشتستان","گاوارت","خاتون‌آباد",
      "آندوان","کلمان","کنگاز","ارداجی","کردآباد","پینارت","شهرک زاینده‌رود","شهرک سلامت","ارغوانیه",
    ].map((name) => ({ name, lat: 32.70, lng: 51.71 })),
  },
  {
    title: "غرب و شهرک‌ها",
    items: [
      "آبشار","اشرفی اصفهانی","اسلامی","بهار آزادی","بهارانچی","بزرگمهر","بابوکان","جروکان","جوان",
      "جامی","زاجان","زهران","سجاد","سیمین","سه‌راه سیمین","صمدیه لباف","ظفر","کاردالان","گلخانه",
      "گلستان","گورتان","خرم","درچه","لادان","لیمجیر","مشاهده","ناژوان","نصرآباد","وحید","والدان",
      "شهرک قدس","شهرک نگین","شهرک ولی‌عصر","شهرک شهید کشوری","فردوان","فرح‌آباد","فیض","کوهانستان",
      "کوی بهارستان غربی","گلسار","مارچین","ملک‌زاده","آزادان","حسین‌آباد","شاهد غربی","شهرک کوثر",
